        ...
        <div className="flex flex-col items-center gap-8 md:flex-row">
          ...
          <div className="space-y-4 text-center md:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-3 md:justify-start">
              ...
              <a href="mailto:dineshwev.tcr@gmail.com" className="rounded-full border border-cyan-400/20 bg-cyan-400/10 px-4 py-2 text-xs font-semibold text-cyan-400 transition hover:bg-cyan-400/20">Email Me</a>
            </div>
          </div>
        </div>
      </section>
